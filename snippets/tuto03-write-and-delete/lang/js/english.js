/** 
* @file
* Local javascript file: 1001_addon/assets/snippets/tuto03-write-and-delete/lang/js/english.js
*/
...
function select_empty_ajax(temp_insert_id)
{
	...
	mil_ajax ({
		form_id: "insert_form"
		, url: window.location.protocol + "//" + window.location.hostname + "/1001_addon/assets/snippets/tuto03-write-and-delete/server.select_empty.ajax.php"
		, data: {
			temp_insert_id: {
	...
	function on_success (ajaxReturn, textStatus, jqXHR)
	{
		...
		{
			$("#input_div").datamalico(ajaxReturn).display({field_name : "fullname", row_num: 1});
...
function insert_ajax ()
{
	...
	mil_ajax ({
		form_id: "insert_form"
		, url: window.location.protocol + "//" + window.location.hostname + "/1001_addon/assets/snippets/tuto03-write-and-delete/server.delupsert.ajax.php"
		, success: on_success
	});
...
function select_ajax ()
{
	mil_ajax ({	// you can use any other ajax method to reach your server page. I'm using my own mil_ajax() method. See the mil_ library for more information.
		...
		, url: window.location.protocol + "//" + window.location.hostname + "/1001_addon/assets/snippets/tuto03-write-and-delete/server.select.ajax.php"	// the path to reach your ajax responding server page which returns a json result of a mysql query.
