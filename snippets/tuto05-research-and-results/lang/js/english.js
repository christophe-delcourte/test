/** 
* @file
* Local javascript file: 1001_addon/assets/snippets/tuto05-research-and-results/lang/js/english.js
*/
...
function get_from_ajax ()
{
	...
	mil_ajax ({
		...
		, url: window.location.protocol + "//" + window.location.hostname + "/1001_addon/assets/snippets/tuto05-research-and-results/server.get_research_form.ajax.php"
		, success: on_success
	});
...
function select_ajax ()
{
	...
	mil_ajax ({
		...
		, url: window.location.protocol + "//" + window.location.hostname + "/1001_addon/assets/snippets/tuto05-research-and-results/server.select.ajax.php"
		, success: on_success
	});
